...
public class Principal4 {
	...
	public static void main(String[] args) {
		...
		Predicate<Empleado> preEmp00 =  w -> true;
		...
		Predicate<String> preString = s -> s.equals("Hola");
		System.out.println(preString.test(new String("Hola")));
		
	}
	
	static void mostrar(List<Empleado> lista, Predicate<Empleado> preEmp) {
